        ...
        <div className=''>
            <div className='flex items-center justify-between h-[70px] shadow-md px-[25px] '>
                <div className='flex items-center rounded-[5px]'>
                    ...
                    <div className='bg-purple-800 hover:bg-purple-700 h-[40px] px-[14px] flex items-center justify-center cursor-pointer rounded-tr-[5px] rounded-br-[5px]'>
                    <button onClick={toggleSidebar}><AiOutlineBars color='white' /></button> 
